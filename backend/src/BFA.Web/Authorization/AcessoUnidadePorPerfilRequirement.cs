...
public sealed class AcessoUnidadePorPerfilRequirement : IAuthorizationRequirement
{
    public AcessoUnidadePorPerfilRequirement(params PerfilAcesso[] perfisPermitidos)
    {
