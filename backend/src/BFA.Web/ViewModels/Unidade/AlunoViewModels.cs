...
internal static class AlunosViewModelMapper
{
        ...
        bool aguardandoPrimeiroAcesso)
    {
        ...
        return new AlunoDetalheItemViewModel
        {
            ...
            Telefone = TelefoneBrasileiro.FormatarLocal(detalhe.Telefone),
            Email = detalhe.Email,
            Ativo = detalhe.Ativo,
            Responsaveis = detalhe.Responsaveis.Select(r => new ResponsavelAlunoViewModel(
                r.ResponsavelId,
                r.NomeCompleto,
                TelefoneBrasileiro.FormatarLocal(r.Telefone),
                r.Email,
        ...
        bool podeTrocar) => new()
    {
        ...
        Responsavel = new ResponsavelDetalheItemViewModel
        {
            ...
            Telefone = TelefoneBrasileiro.FormatarLocal(responsavel.Telefone),
